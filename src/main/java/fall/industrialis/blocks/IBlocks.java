...
public class IBlocks {
    ...
    public static final Block ELECTRIC_COMPRESSOR = registerBlock("electric_compressor",
            new ElectricCompressorBlock(FabricBlockSettings.of(Material.STONE).strength(4f).requiresTool()));
